      ...
      services.hypridle = {
        ...
        settings = {
          ...
          listener = [
            ...
            {
              timeout = 60; # 2.5min.
              on-timeout = "notify-send -a \"Idle 1\" aaa"; # set monitor backlight to minimum, avoid 0 on OLED monitor.
            }
            {
              timeout = 90; # 5min
            ...
            {
              timeout = 90; # 5min.
              on-timeout = "notify-send -a \"Idle 2\" aaa"; # set monitor backlight to minimum, avoid 0 on OLED monitor.
            }
            {
              timeout = 120; # 5.5min
            ...
            {
              timeout = 120; # 2.5min.
              on-timeout = "notify-send -a \"Idle 3\" aaa"; # set monitor backlight to minimum, avoid 0 on OLED monitor.
            }
            {
              timeout = 150; # 10min
            ...
            {
              timeout = 150; # 2.5min.
              on-timeout = "notify-send -a \"Idle 4\" aaa"; # set monitor backlight to minimum, avoid 0 on OLED monitor.
            }
          ];
        };
      };
